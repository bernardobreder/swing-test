...
public class GFont {
	 ...
	 * font resource. The TrueType format was extended to become the OpenType
	 * format, which adds support for fonts with Postscript outlines, this tag
	 * therefore references these fonts, as well as those with TrueType
	 * outlines.
	 *
	 * @since 1.3
	 */
	 ...
	 * @param size
	 */
	public GFont(String name, int style, int size) {
	...
	public boolean equals(Object obj) {
		...
		return size == other.size && style == other.style && name.equals(other.name);
	}
	...
	public String toString() {
		...
		return "[name=" + name + ",style=" + strStyle + ",size=" + size + "]";
	}
	 ...
	 * @since 1.2
	 */
	public GFont deriveStyleSize(int style, float size) {
		return new GFont(name, style, (int) size);
	}
	 ...
	 * @since 1.2
	 */
	public GFont deriveSize(float size) {
		return new GFont(name, style, (int) size);
	}
	 ...
	 * @since 1.2
	 */
	public GFont deriveStyle(int style) {
		return new GFont(name, style, size);
	}

	/**
	 * Retorna a fonte em AWT
	 * 
	 * @return fonte em AWT
	 */
	public Font driver() {
